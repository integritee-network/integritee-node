...
use encointer_node_teeproxy_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	encointer_node_teeproxy_runtime::api::dispatch,
	encointer_node_teeproxy_runtime::native_version,	
